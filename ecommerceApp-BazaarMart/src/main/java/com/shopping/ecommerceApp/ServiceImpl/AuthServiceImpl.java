package com.shopping.ecommerceApp.ServiceImpl;

import com.shopping.ecommerceApp.Config.JwtProvider;
import com.shopping.ecommerceApp.Model.Cart;
import com.shopping.ecommerceApp.Model.User;
import com.shopping.ecommerceApp.Repository.CartRepository;
...
public class AuthServiceImpl implements AuthService {
    ...
    public String createUser(SignupRequest req) {
        ...
        if(user==null){
           ...
           createdUser.setMobile("8304899004");
